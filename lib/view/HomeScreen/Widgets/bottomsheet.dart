...
import 'package:musicplayer/view/HomeScreen/Widgets/dialogboxbottomsheet.dart';
                        ...
                        ListView.builder(
                          ...
                          itemBuilder: ((context, index) {
                            return Padding(
                              ...
                              child: InkWell(
                                onTap: () {
                                  if (playc.playlistlist[index].songlist
                                      .contains(song)) {
                                    Get.snackbar('', 'Song already Contains',
                                    ...
                                    playc.playlistSongsAddDB(
                                        song, playc.playlistlist[index].name);
                                    playc.playlistlist[index].songlist
                                        .add(song);
